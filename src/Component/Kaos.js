...
const DetailKaos = createContext();
...
export default function Kaos() {
    ...
    return (
        <div style={{ marginTop: 20 }}>
            ...
            <center>
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900" style={{fontFamily:"Roboto", letterSpacing:"1px"}}>Daftar Kaos</h1> 
            </center>
            ...
            <DetailKaos.Provider value={{ judul: judul, deskripsi: deskripsi }}>
                <div>
                    <Modal
                        open={open}
                        onClose={handleClose}
                        aria-labelledby="modal-modal-kaos"
...
function Detail() {
    const info = useContext(DetailKaos);
    return (
        <Box sx={style}>
            <center>
            <Typography id="modal-modal-kaos" variant="h6" component="h2">
                {info.judul}
            </Typography>
            </center>
