...
export default function Rok() {
    ...
    return (
        <div style={{ marginTop: 20 }}>
            ...
            <center>
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900" style={{fontFamily:"Roboto", letterSpacing:"1px"}}>Daftar Rok</h1> 
            </center>
            ...
            <DetailRok.Provider value={{ judul: judul, deskripsi: deskripsi }}>
                <div>
                    <Modal
                        open={open}
                        onClose={handleClose}
                        aria-labelledby="modal-modal-rok"
...
function Detail() {
    const info = useContext(DetailRok);
    return (
        <Box sx={style}>
            <center>
            <Typography id="modal-modal-rok" variant="h6" component="h2">
                {info.judul}
            </Typography>
            </center>
